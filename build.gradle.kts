...
paperweight {
    serverProject.set(project(":paperfake-server"))
    ...
    useStandardUpstream("pufferfish") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("paperfake-api"))
            serverOutputDir.set(layout.projectDirectory.dir("paperfake-server"))
        }
    }
}
